"use strict";
(self["webpackChunkexb_client"] = self["webpackChunkexb_client"] || []).push([["vendors-node_modules_arcgis_map-components_dist_esm_arcgis-directional-pad_entry_js"],{
...
/* harmony export */   arcgis_directional_pad: () => (/* binding */ ArcgisDirectionalPad)
/* harmony export */ });
...
const ArcgisDirectionalPad = class {
    constructor(hostRef) {
        ...
        this.arcgisDirectionalPadReady = (0,_index_6e172aac_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "arcgisDirectionalPadReady", 7);
        this._watchHandles = [];
    ...
    visualScaleWatcher(value) {
        if (this.widget) {
            this.widget.visualScale = value;
        }
    }
    ...
    async componentDidLoad() {
        ...
        const widget = await (0,_index_0bc55ca5_js__WEBPACK_IMPORTED_MODULE_1__.q)(params);
        this.widget = widget;
        this._addContainer();
        this.arcgisDirectionalPadReady.emit();
...
ArcgisDirectionalPad.style = directionalPadCss;
